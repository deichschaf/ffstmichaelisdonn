...
<head>
    ...
    <title>Adminbereich - {!! env('HOMEPAGE_TITLE') !!}</title>
...
<div id="root"></div>
@env('local')
<script type="text/javascript" src="/js/admin_bundle.js?t={!! time() !!}"></script>
@endenv
@env('production')
    <script type="text/javascript" src="/js/admin_bundle.{!! time() !!}.js"></script>
@endenv
</body>
</html>
