...
import { NewsProps } from '../../props/props';

const NewsAddEditComponent: React.FC<NewsProps> = (props: NewsProps): JSX.Element => {
  ...
  useEffect(() => {
    async function fetchMyApi() {
      let response = await fetch(`/api/admin/news/data/${id}`);
    ...
    async function getSelects() {
      let response = await fetch('/api/admin/news/getParentAreas');
      response = await response.json();
    ...
    <div className="container">
      <div className="overview_headline">
        ...
        <ErrorBoundary>
          ...
          <SaveLine SubmitForm={SubmitForm} backurl="/admin/news/overview" />
        </ErrorBoundary>
        <ErrorBoundary>
          <SaveInfoError responseText={responseText} errorText={errorText} />
        </ErrorBoundary>
...
export default NewsAddEditComponent;
