...
import { PageAddEditComponentProps } from '../../props/props';

const PageAddEditComponent: React.FC<React.PropsWithChildren<PageAddEditComponentProps>> = (
  props: PageAddEditComponentProps,
): JSX.Element => {
        ...
        <ErrorBoundary>
          <Row>
            <Col xxl={12} xl={12} lg={12} md={12} sm={12} xs={12}>
              <PageHeadline label={`Admin - Seite ${getEditType}`} />
            </Col>
          </Row>
          <Row>
            <Col xxl={12} xl={12} lg={12} md={12} sm={12} xs={12}>
...
export default PageAddEditComponent;
