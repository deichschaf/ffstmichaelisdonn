...
import { AlertBoxErrorProps } from '../../../../props/props';
import Button from '../../../atoms/Buttons/Button';
import FAS from '../../../atoms/Icon/FAS';
import H5 from '../../../atoms/Typography/H5';
import P from '../../../atoms/Typography/P';

const AlertErrorBox: React.FC<React.PropsWithChildren<AlertBoxErrorProps>> = (
  props: AlertBoxErrorProps,
): JSX.Element => {
  ...
  function makePBlock(props) {
    ...
    return datas.map((item, idx) => <div key={idx}>{item}</div>);
  }
  ...
  return (
    <div className="alert alert-block alert-error fade in show">
      <h4 className="alert-heading">
        <FAS className="exclamation-circle" /> Error!
      </h4>
      {makeHeadline(props)}
      {makePBlock(props)}
      {makeP(props)}
