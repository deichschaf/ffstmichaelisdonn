...
import { AlertBoxWarningProps } from '../../../../props/props';
import Button from '../../../atoms/Buttons/Button';
import FAS from '../../../atoms/Icon/FAS';
import H5 from '../../../atoms/Typography/H5';
import P from '../../../atoms/Typography/P';

const AlertWarningBox: React.FC<React.PropsWithChildren<AlertBoxWarningProps>> = (
  props: AlertBoxWarningProps,
): JSX.Element => (
  <div className="alert alert-block alert-warning fade in">
    <Button type="button" className="close" data-dismiss="alert" />
    <h4 className="alert-heading">
      <FAS className="exclamation-circle" /> Warning!
    </h4>
...
export default AlertWarningBox;
