...
const ManagementSmallDetail: React.FC<React.PropsWithChildren<ManagementFullDetailProps>> = (
  props: ManagementFullDetailProps,
): JSX.Element => {
  if (typeof props.firstname === 'undefined') {
    return <></>;
  }
  return (
    <ErrorBoundary>
...
export default ManagementSmallDetail;
