...
import ManagementSmallDetail from './ManagementSmallDetail';

const ManagementSmall: React.FC<React.PropsWithChildren<ManagementFullProps>> = (
...
export default ManagementSmall;
