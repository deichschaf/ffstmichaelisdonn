...
import { PageAppWrapperProps } from '../../../props/props';
...
const PageAppWrapper: React.FC<React.PropsWithChildren<PageAppWrapperProps>> = (
  props: PageAppWrapperProps
): JSX.Element => {
